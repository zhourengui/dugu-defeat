...
describe("test Input component", () => {
  it("should render the correct default Input", () => {
    ...
    expect(testNode).toHaveClass(`${inputPrefixCls}-inner`);
  ...
  it("should render different input sizes on size property", () => {
    ...
    const testContainer = wrapper.container.querySelector(`.${inputPrefixCls}`);
    expect(testContainer).toHaveClass(`${inputPrefixCls}-size-large`);
  });
  it("should render prepand and append element on prepand/append property", () => {
    ...
    const testContainer = container.querySelector(`.${inputPrefixCls}`);
